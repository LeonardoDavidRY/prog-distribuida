CREATE TABLE book_author (
    ...
    CONSTRAINT fk_book_author_books FOREIGN KEY (books_isbn) REFERENCES books(isbn),
    CONSTRAINT fk_book_author_authors FOREIGN KEY (authors_id) REFERENCES authors(id)
);
